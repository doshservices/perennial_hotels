...
const pipelineProjects = [
  ...
  {
    name: "Perennia Axari Hotel, Calabar",
    location: "Calabar, Cross River State, Nigeria",
    acreage: "15,000 Sqm",
    dealType: "Development & Management",
    dealSize: "US$ 15 million (New Development)",
    assetType:
      "Mixed-use development with shopping mall and entertainment center",
    rooms: "90 keys with boutique hotel rooms",
    foodAndBeverage: "3 Restaurants, 2 cafes",
    pools: "1 rooftop infinity pool",
    banqueting: "Large multipurpose event space, 3 meeting rooms",
    otherFacilities: "Gym, spa, retail shops, cinema, children's play area",
    desktopImage: "/assets/axari-desktop.png",
    mobileImage: "/assets/axari-mobile.png",
  },
  {
    name: "Perennia Zephyr Luxury Apartments, Lagos",
    location: "Oniru, Lagos, Nigeria",
    acreage: "12,500 Sqm",
    dealType: "Residential Development",
    dealSize: "US$ 20 million",
    assetType: "Luxury residential complex with premium amenities",
    rooms: "100 luxury apartments across multiple towers",
    foodAndBeverage: "Rooftop restaurant and lounge",
    pools: "2 pools (main pool and lap pool)",
    banqueting: "Multipurpose community hall",
    otherFacilities:
      "Gym, spa, co-working spaces, children's play area, 24/7 security",
